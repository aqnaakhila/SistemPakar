...
def infer(data):
    ...
    if lt == 'perlu Upgrade kualitas' and sb == 'Tidak perlu perbaikan' and kr == 'Memenuhi aturan' and kp == 'Pelanggan puas':
        ...
        explanation.append("Rule 8: Semua kondisi baik tapi layanan teknis perlu upgrade → ISP Perlu peningkatan")
    ...
    # Aturan 2
        ...
        explanation.append("Rule 9: Pelanggan tidak puas → ISP Bermasalah")

    # Aturan 3
    elif lt == 'perlu Upgrade kualitas' and sb == 'Perlu perbaikan' and kp == 'Pelanggan puas':
        result = 'ISP Perlu Peningkatan'
        explanation.append("Rule 10: Strategi perlu perbaikan tapi pelanggan puas → ISP Perlu Peningkatan")
    ...
    # Rule 13
        ...
        result = 'ISP Perlu Peningkatan'
        explanation.append("Rule 19: Regulasi dan pelanggan buruk meski layanan bagus → ISP Perlu Peningkatan")

    # Rule 14
    elif lt == 'perlu Upgrade kualitas' and sb == 'Tidak perlu perbaikan' and kr == 'Tidak memenuhi aturan' and kp == 'Pelanggan puas':
        result = 'ISP Perlu Peningkatan'
        explanation.append("Rule 20: Regulasi dan teknis lemah meski pelanggan puas → ISP Perlu Peningkatan")

    # Rule 15
    elif lt == 'Tidak perlu upgrade kualitas' and sb == 'Perlu perbaikan' and kr == 'Memenuhi aturan' and kp == 'Pelanggan tidak puas':
        result = 'ISP Perlu Peningkatan'
        explanation.append("Rule 21: Strategi buruk dan pelanggan tidak puas → ISP Perlu Peningkatan")
