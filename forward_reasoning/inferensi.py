...
def infer(data):
    ...
    if lt == 'perlu Upgrade kualitas' and sb == 'Tidak perlu perbaikan' and kr == 'Memenuhi aturan' and kp == 'Pelanggan puas':
        ...
        explanation.append("Rule 1: Semua kondisi baik tapi layanan teknis perlu upgrade → ISP Perlu peningkatan")
    ...
    # Rule 13
        ...
        result = 'ISP Perlu Peningkatan'
        explanation.append("Rule 13: Regulasi dan pelanggan buruk meski layanan bagus → ISP Perlu Peningkatan")

    # Rule 14
    elif lt == 'perlu Upgrade kualitas' and sb == 'Tidak perlu perbaikan' and kr == 'Tidak memenuhi aturan' and kp == 'Pelanggan puas':
        result = 'ISP Perlu Peningkatan'
        explanation.append("Rule 14: Regulasi dan teknis lemah meski pelanggan puas → ISP Perlu Peningkatan")

    # Rule 15
    elif lt == 'Tidak perlu upgrade kualitas' and sb == 'Perlu perbaikan' and kr == 'Memenuhi aturan' and kp == 'Pelanggan tidak puas':
        result = 'ISP Perlu Peningkatan'
        explanation.append("Rule 15: Strategi buruk dan pelanggan tidak puas → ISP Perlu Peningkatan")
